...
export const SERVICE_TYPES = {
  ...
  DRONE: 'drone',
  MAKING_OF: 'making_of',
  MAKING_OF_BRIDE: 'making_of_bride',
  MAKING_OF_GROOM: 'making_of_groom',
  FRESTA: 'fresta',
  FILMMAKER: 'filmmaker',
...
export const SERVICE_TYPE_LABELS = {
  ...
  [SERVICE_TYPES.MAKING_OF_BRIDE]: 'Making of noiva',
  [SERVICE_TYPES.MAKING_OF_GROOM]: 'Making of noivo',
